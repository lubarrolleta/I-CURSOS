...
/* .scale-up-center {
	-webkit-animation: scale-up-center 0.4s cubic-bezier(0.215, 0.610, 0.355, 1.000) 0.4s both;
	        animation: scale-up-center 0.4s cubic-bezier(0.215, 0.610, 0.355, 1.000) 0.4s both;
} */
.scale-up-center {
...
.scale-up-back {
	-webkit-animation: scale-up-back 0.4s cubic-bezier(0.215, 0.610, 0.355, 1.000) reverse both;
	        animation: scale-up-back 0.4s cubic-bezier(0.215, 0.610, 0.355, 1.000) reverse both;
}
/* ----------------------------------------------
...
@-webkit-keyframes scale-up-back {
  0% {
    -webkit-transform: scale(1);
            transform: scale(1);
            /* opacity: 0; */
